...
# 	•	For all columns (y01 to y10), both the t-test and K-S test show very small p-values, indicating that the testing data does not come from condition d. This conclusion is consistent across both the mean comparison (t-test) and the distribution comparison (K-S test).

# Conclusion:

# 	•	The hypothesis test results strongly suggest that the testing data does not come from condition d for any of the current columns (y01 to y10).