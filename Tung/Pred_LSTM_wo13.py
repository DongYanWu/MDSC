...
model_path = '/Users/wudongyan/Desktop/lstm_saved_models_wo13_v2/lstm_model_c_v2.h5'
...
predictions_df.to_csv('answer_lstm_wo13_v2.csv', index=False)
print("Predictions saved to 'answer_lstm_wo13_v2.csv'.")