...
model_base_path = '/Users/wudongyan/Desktop/rf_cross_saved_models/'  # Folder where models are saved
...
for material in range(1, 14):  # For materials 1 to 13
    for voltage in ['b', 'c']:  # Excluding voltage conditions `a` and `d`
...
predictions_df.to_csv('answerrf.csv', index=False)
print("Predictions saved to 'answerrf.csv'.")