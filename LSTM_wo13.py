...
model_save_path = '/Users/wudongyan/Desktop/lstm_saved_models_wo13_v2/'  # Replace with your actual save path
...
for material in training_data['material'].unique():
    for voltage in training_data['voltage'].unique():
        ...
        lagged_data = []
        for lag in range(1, 3):  # Create 3 lagged features
...
model_save_filename = 'lstm_model_c_v2.h5'
